...
export default function App() {
   ...
   const [successAnimationType, setSuccessAnimationType] = useState(localStorage.getItem('success_animation_type') || 'confetti');
   const handleSetAnimationType = (type: string) => { setSuccessAnimationType(type); localStorage.setItem('success_animation_type', type); };
